...
## 品级颜色映射：最多 5 档，从低到高 灰、绿、蓝、金、红
const TIER_COLORS := [
	Color(0.60, 0.60, 0.65, 1.0),   # tier 0: 灰
	Color(0.35, 0.85, 0.45, 1.0),   # tier 1: 绿
	Color(0.35, 0.55, 0.95, 1.0),   # tier 2: 蓝
	Color(0.95, 0.75, 0.25, 1.0),   # tier 3: 金
	Color(0.95, 0.35, 0.35, 1.0),   # tier 4: 红
]
